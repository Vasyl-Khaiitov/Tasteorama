...
export function RecipeCard({ dishPhoto, recipeName, recipeDescription, recipeTime }) {
        ...
        <div className={style.card}>
            ...
            <div className={style.header}>
                ...
                <div className={style.containerTime}>
                    <p className={style.time}> <Icon name="clock" classname={style.icon} /> {recipeTime} </p>
                </div>
            ...
            <div className={style.btnContainer}>
                ...
                <button className={style.btnIcon}>  <Icon name="flag" classname={style.icon} /> </button>
            </div>
        </div>
    )
